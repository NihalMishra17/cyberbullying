...
class GUI:
    ...
    def layout(self):
        ...
        self.Window.title("Chat Analyzer")
    ...
    def prettyPrinter(self,data_1):
         # List of stopwords 
        my_file = open("C:/Users/mishr/Documents/FinalProject/FinalProject/Safe_Chat/stopwords.txt", "r")
        content = my_file.read()
        content_list = content.split("\n")
        my_file.close()
        tfidf_vector =  TfidfVectorizer(stop_words = content_list, lowercase = True,vocabulary=pickle.load(open("C:/Users/mishr/Documents/FinalProject/FinalProject/Safe_Chat/tfidf_vector_vocabulary.pkl", "rb")))
        data_2=tfidf_vector.fit_transform([data_1])
        print(data_2)
        model = pickle.load(open("C:/Users/mishr/Documents/FinalProject/FinalProject/Safe_Chat/LinearSVC.pkl", 'rb'))
